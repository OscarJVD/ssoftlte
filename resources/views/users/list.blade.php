                ...
                <div class="row justify-content-center rounded border p-3 mb-1">
                    ...
                    <div class="col-md-6">
                        <article class="col-md-12 col-md-offset-1">
                            <form action="{{ url(Auth::user()->urlSearch('user')) }}" method="post" novalidate
                                class="form-inline">
                                @csrf
                                <div class="row justify-content-center text-center">
                                    <div class="col-md-12">
                                        <div class="row justify-content-center">
                                            <input type="text" id="search" placeholder="Buscar" name="name"
                                                class="form-control mr-1 mb-1" required>
                                            <div class="">
                                        ...
                                        <td>
                                            @if (Auth::user()->role->name != 'Cliente')
                                                <a class="btn btn-outline-primary btn-sm my-2"
                                                    href="{{ url(Auth::user()->urlEdit('user', $user->id)) }}">Editar</a>
                                                <a class="btn btn-outline-danger btn-sm"
                                                    href="{{ url(Auth::user()->urlDelete('user', $user->id)) }}">Eliminar</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
